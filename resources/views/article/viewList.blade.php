...
@section('navbar_background')
    <div class="slide-one-item home-slider owl-carousel">
        @if(count($randomarticles) == 0)
            <div class="site-blocks-cover overlay" style="{{ URL::asset('storage//photos/default.jpg' }};" data-aos="fade" data-stellar-background-ratio="0.5">
                <div class="container">
        ...
        @else
            @foreach ($randomarticles as $article)
                <div class="site-blocks-cover overlay" style="{{ URL::asset('storage//photos/'.$article->photo[0]->photo) }};" data-aos="fade" data-stellar-background-ratio="0.5">
                    <div class="container">
                        <div class="row align-items-center justify-content-center text-center">
                            <div class="col-md-10">
                                @if ($article->for == 'sale')
